...
const services = [
  {
    ...
    description:
      `We understand you have questions. Learn more about our simplified waivers and find out if your upcoming flight qualifies.`,
  },
  {
    img:
    ...
    description:
      `If your trip has been impacted by coronavirus, it's easy to cancel or change your flights. Learn how to modify your trip and rebook using eCredits with our step-by-step guides.`,
  },
  {
    img:
...
const posts = [
  {
    ...
    description:
      `Learn how Delta is continuing to evaluate and make adjustments to your travel experience while staying in close coordination with the CDC and WHO to ensure your safety.`,
  },
  {
    img:
...
const products = [
  {
    ...
    description:
      `Download the app to be notified of flight updates and access your mobile boarding pass to limit the use of touch-screen kiosks. `,
  },
  {
    img:
    ...
    description:
      `We're ready when you are. We are waiving change fees broadly and, above all, rest assured the value of your ticket won't be lost if you need to make a change. `,
  },
];
